...
export function PathPopulationGroupsAlt({
  onLoadData,
  countries,
  dataReady,
  data,
  ...
  return (
    <article>
      <Helmet>
        ...
        <meta name="description" content="PathPopulationGroupsAlt" />
      </Helmet>
      <div>
        <ChartBeeswarm
          data={chartData}
...
PathPopulationGroupsAlt.propTypes = {
...
export default compose(
  withConnect,
  memo,
)(injectIntl(PathPopulationGroupsAlt));
