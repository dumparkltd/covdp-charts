...
export function PathUHCAlt({ onLoadData, countries, dataReady, data }) {
  ...
  const config = DATA_RESOURCES.find(r => r.key === 'uhc-coverage-alt');
  ...
  return (
    <article>
      <Helmet>
        ...
        <meta name="description" content="PathUHCAlt" />
      </Helmet>
      <div>
        <ChartScatter
          data={chartData}
